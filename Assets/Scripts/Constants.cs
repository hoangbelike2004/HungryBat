...
public static class Constants
{
    ...
    public const string PREFAB_NORMAL_TYPE_TWO = "Prefabs/Banana";

    public const string PREFAB_NORMAL_TYPE_THREE = "Prefabs/BlueBerry";

    public const string PREFAB_NORMAL_TYPE_FOUR = "Prefabs/Grapes";

    public const string PREFAB_NORMAL_TYPE_FIVE = "Prefabs/Orange";

    public const string PREFAB_NORMAL_TYPE_SIX = "Prefabs/Pear";

    public const string PREFAB_NORMAL_TYPE_SEVEN = "Prefabs/Strawberry";

    public const string PREFAB_BONUS_HORIZONTAL = "Prefabs/Horizontal";
    ...
    public const string PREFAB_NORMAL_TYPE_THREE_UI = "UI/blueBerryUI";

    public const string PREFAB_NORMAL_TYPE_FOUR_UI= "UI/grapesUI";

    public const string PREFAB_NORMAL_TYPE_FIVE_UI = "UI/orangeUI";
